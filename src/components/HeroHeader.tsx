    ...
    <Paper shadow="xl" radius="lg" p="xl" withBorder>
      ...
      <Center>
        <Text ta="center" size="md" color="white">
          At my core, I am a passionate learner and creator, which fuels my
          technical skills as a software developer. My project experience
          primarily revolves around ReactJS, NodeJS, MantineUI, JavaScript, and
          TypeScript. Recently, I graduated with a BASc in Software Development
          from Valencia College and am based in Orlando, FL. Below are links to
          my Upwork, LinkedIn, Github, resume, and email.
        </Text>
      </Center>
      <Space h="md" />
